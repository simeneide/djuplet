...
def split_and_save(input_file, output_dir):
    ...
    with open(os.path.join(output_dir, "dataset_info.json"), 'w', encoding='utf-8') as info_file:
...
if __name__ == "__main__":
    ...
    # Create a temporary directory to store the splits.
    # This directory will be automatically deleted after the with-block.
